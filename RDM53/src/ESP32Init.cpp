...
/**
 * initialize the RDM53 WiFi
 * Set the RTC over NTP
 * start beep
 */
void RDMWiFiInit() {
...
/**
 * setup WiFi for enterprise use (eduroam)
 * based on:
 ...
 * and calculates the remaining capacity in per cent
 */
